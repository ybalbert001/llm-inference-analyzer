...
MSG = {
    ...
    "html.lbl_dense_repl": {"zh": "dense 层复制（moe_dense_tp=1，前几层 dense FFN 每卡整份不切）",
                            "en": "dense replicated (moe_dense_tp=1; leading dense FFN kept whole per rank)"},
    ...
    # raw-source pane (section 0): the primary files side by side (3 for sharded
    # checkpoints, 2 for single-file ones without an index.json)
